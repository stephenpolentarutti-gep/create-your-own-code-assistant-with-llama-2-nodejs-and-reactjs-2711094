...
class KuzcoPanel {
    ...
    static render(extensionUri) {
        if (KuzcoPanel.currentPanel) {
            // If the webview panel already exists reveal it
            KuzcoPanel.currentPanel._panel.reveal(vscode_1.ViewColumn.One);
        }
        else {
            ...
            KuzcoPanel.currentPanel = new KuzcoPanel(panel, extensionUri);
        }
    }
    /**
     ...
     */
    dispose() {
        KuzcoPanel.currentPanel = undefined;
...
exports.KuzcoPanel = KuzcoPanel;
//# sourceMappingURL=KuzcoPanel.js.map